...
export function RoleAuth() {
  ...
  const handleSignIn = async () => {
    ...
    // Triggering Supabase OAuth and persisting the role
    ...
    <div className={styles.container}>
      <div className={styles.authCard}>
        <div className={styles.header}>
          <h1 className={styles.title}>Join Project Foosha</h1>
        ...
        {/* PROMINENT GOOGLE BUTTON (Appears only after role is chosen) */}
        {selectedRole && (
