    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[60] flex justify-end">
          ...
          />
          <div className="relative h-full w-[82vw] max-w-[22rem] bg-[var(--bg-deep)] border-l border-[var(--line)] shadow-2xl flex flex-col p-6 overflow-y-auto z-[61] animate-in slide-in-from-right duration-300">
            ...
            <nav className="flex flex-1 items-center py-6" aria-label="Mobile navigation">
              <div className="flex w-full flex-col gap-5 text-left text-base font-medium">
            ...
            <div className="flex shrink-0 flex-col gap-5 border-t border-[var(--line)] pt-5 text-left text-base font-medium">
